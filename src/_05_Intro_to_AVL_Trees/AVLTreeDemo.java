...
public class AVLTreeDemo {
	 ...
	 * a regular binary tree, depending on the elements inserted, you might have a
	 ...
	 * 
	 * 3.) Insert the same values into both trees and observe how they differ using
	 * the print method. Make sure the values you pick unbalance the binary tree.
	 * 
	...
	public static void main(String[] args) {
		BinaryTree<Integer> bynaree = new BinaryTree<Integer>();
		AVLTree<Integer> avl = new AVLTree<Integer>();
		for (int i = 0; i < 5; i++) {
			bynaree.insert(i);
			avl.insert(i);
		}
		bynaree.printVertical();
		avl.printVertical();
		bynaree.delete(2);
		avl.delete(2);
	}
